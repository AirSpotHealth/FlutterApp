...
const NotificationPreferencesSchema = IsarGeneratedSchema(
  schema: IsarSchema(
  ...
  embeddedSchemas: [NotificationThresholdSchema],
);
...
int serializeNotificationPreferences(
  ...
  IsarCore.writeBool(writer, 2, object.smartphoneNotificationsEnabled);
  {
...
NotificationPreferences deserializeNotificationPreferences(IsarReader reader) {
  ...
  final bool _notificationSoundEnabled;
  {
    if (IsarCore.readNull(reader, 4)) {
      _notificationSoundEnabled = true;
    } else {
      _notificationSoundEnabled = IsarCore.readBool(reader, 4);
    }
  }
  final bool _notificationVibrationEnabled;
  {
    if (IsarCore.readNull(reader, 5)) {
      ...
      _notificationVibrationEnabled = IsarCore.readBool(reader, 5);
    }
  }
...
class _NotificationPreferencesUpdateImpl
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (notificationSoundEnabled != ignore)
            4: notificationSoundEnabled as bool?,
...
extension NotificationPreferencesQueryFilter on QueryBuilder<
  ...
  QueryBuilder<NotificationPreferences, NotificationPreferences,
      QAfterFilterCondition> notificationSoundEnabledEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
const NotificationThresholdSchema = IsarGeneratedSchema(
  schema: IsarSchema(
...
int serializeNotificationThreshold(
  ...
  IsarCore.writeBool(writer, 3, object.enabled);
  {
